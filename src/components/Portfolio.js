  ...
  return (
    ...
    >
      ...
      <a
        ...
        <a
          className="myPortfolioImage"
          href="https://lespuch-v.github.io/React-Quizz-APP/"
          alt="Quizz APP"
        >
          <div className="itm-container">
            <h5>Quizz APP</h5>
        ...
        <a
          className="myPortfolioImage"
          href="https://lespuch-v.github.io/ReactJS-MemeGenerator/"
        >
          <div className="itm-container">
            <h5>MemeGen</h5>
            <img
        ...
        <a
          className="myPortfolioImage"
          href="https://lespuch-v.github.io/Chrome-Extension-Crypto-Dashboard/"
        >
          <div className="itm-container">
        ...
        <a
          className="myPortfolioImage"
          href="https://lespuch-v.github.io/Christmas-Countdown-/"
        >
          <div className="itm-container">
            <h5>X-Mas Counter</h5>
            <img
        ...
        <a
          className="myPortfolioImage"
          href="https://lespuch-v.github.io/SnameGame/"
        >
          <div className="itm-container">
            <h5>Snake Game</h5>
